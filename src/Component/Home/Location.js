...
import { findlocation } from "./locationSlice";
function Location() {
  const getlocation = useSelector((state) => state.location.location);
    ...
    <>
      <section className="header">
        <div className="header_container">
          <div className="lift_side_container">
            <div className="lift_side_container_top_one">
              ...
              <div className="top_name">
                <div>
                  <a href="home.html">Mervin Jacob</a>
                </div>
              </div>
            </div>
            <div className="top_two_h1">Late night at Office?</div>
            <div className="top_two_p">
              Order food from favourite restaurants near you.
            </div>
            <div style={{ display: "flex" }}>
              <div className="search_bar_container">
                <div className="search_bar_one">
                  <input
                    value={loc}
                    onChange={(e) => {
                ...
                <div className="search_bar_one">
                  <button>
                    <i
                      ...
                      style={{ color: "#7e808c", marginRight: "3px" }}
                    ></i>
                    Locate Me
                  </button>
                </div>
              ...
              <div
                onClick={() => dispatch(findlocation(loc))}
                className="search_bar_three"
              >
                Find Food
              </div>
            </div>
            <div className="top_p">Popular cities in India</div>
            <div
              className="top_ul"
            ...
            >
              <ul>
                <li>Ahmedabad</li>
                <li style={{ color: "#93959f" }}>Bangalore</li>
                <li>Ahmedabad</li>
                <li style={{ color: "#93959f" }}>Chennai</li>
                <li>Delhi</li>
                <li style={{ color: "#93959f" }}>Gurgaon</li>
                <li>Hyderabad</li>
                <li style={{ color: "#93959f" }}>Kolkata</li>
              </ul>
              <ul style={{ marginTop: "0" }}>
                <li style={{ padding: "0" }}>& more.</li>
              </ul>
            </div>
          </div>
      ...
      <section className="body_one">
        <div className="body_one_container">
          <div className="body_one_content">
            ...
            <h1 style={{ marginTop: "30px" }}>Lightning-Fast Delivery</h1>
            <p>
          ...
          <div className="body_one_content">
            ...
            <h1 style={{ marginTop: "43px" }}>No Minimum Order</h1>
            <p>
      ...
      <section className="body_two">
        ...
        <div style={{ position: "absolute", top: -"150", left: "550px" }}>
          <img
            className="_3QGpR"
            width="320"
            height="450"
        ...
        <div style={{ position: "absolute", bottom: "0", left: "900px" }}>
          <img
            className="_2SJnz"
            width="320"
            height="420"
        ...
        <div className="footer_full">
          <div className="footer_container">
            <div className="footer_company">
              ...
              <div className="footer_item">Swiggy Blog</div>
              <div className="footer_item">Bug Bounty</div>
              <div className="footer_item">Swiggy One</div>
              <div className="footer_item">Swiggy Corporate</div>
              <div className="footer_item">Swiggy Instamart</div>
              <div className="footer_item">Swiggy Genie</div>
              <div className="footer_item">Swiggy HDFC Bank Credit Card</div>
            </div>
            <div className="footer_company" style={{ marginRight: "45px" }}>
              <div className="footer_head">CONTACT</div>
              <div className="footer_item">Help & Support</div>
              <div className="footer_item">Partner with us</div>
              <div className="footer_item">Ride with us</div>
            </div>
            <div className="footer_company">
              <div className="footer_head">LEGAL</div>
              <div className="footer_item">Terms & Conditions</div>
              <div className="footer_item">Refund & Cancellation</div>
              <div className="footer_item">Privacy Policy</div>
              <div className="footer_item">Cookie Policy</div>
              <div className="footer_item">Phishing & Fraud</div>
              <div className="footer_item">
                Corporate - Swiggy Money Codes Terms and
                <br />
                Conditions
              </div>
              <div className="footer_item">
                Corporate - Swiggy Discount Voucher Terms and
                <br />
                Conditions
              </div>
            </div>
            <div style={{ marginRight: "30px" }}>
              <div style={{ textAlign: "center" }}>
                <img
                  alt=""
                  src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_200,h_60/icon-AppStore_lg30tv"
                />
              </div>
              <div style={{ marginTop: "40px" }}>
                <img
                  alt=""
                  src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_200,h_60/icon-GooglePlay_1_zixjxl"
                />
              </div>
            </div>
          </div>
      ...
      <section class="footer_two">
        ...
        <div className="footer_two_container">
          <div className="footer_two_list">
            <div className="footer_two_item">Abohar</div>
            <div className="footer_two_item">Adilabad</div>
            <div className="footer_two_item">Adoni</div>
            <div className="footer_two_item">Agra</div>
            <div className="footer_two_item">Ahmedabad</div>
          </div>
          <div className="footer_two_list">
            <div className="footer_two_item">Deoghar</div>
            <div className="footer_two_item">Deoria-city</div>
            <div className="footer_two_item">Dewas</div>
            <div className="footer_two_item">Dhanbad</div>
            <div className="footer_two_item">Dhar</div>
          </div>
          <div className="footer_two_list">
            <div className="footer_two_item">Kishanganj</div>
            <div className="footer_two_item">Kishangarh</div>
            <div className="footer_two_item">Kochi</div>
            <div className="footer_two_item">Kohima</div>
            <div className="footer_two_item">Kokrajhar</div>
          </div>
          <div className="footer_two_list">
            <div className="footer_two_item">Pusad</div>
            <div className="footer_two_item">Puttur</div>
            <div className="footer_two_item">Rae-bareli</div>
            <div className="footer_two_item">Raghunathpur</div>
            <div className="footer_two_item">Raichur</div>
          </div>
        </div>
        <div
          style={{
      ...
      <section className="footer_three">
        <div>
          <h4>Explore Every Restaurants Near Me</h4>
          <div
            style={{
              display: "flex",
          ...
          >
            <div className="footer_three_item">Explore restaurants near me</div>
        ...
        >
          ...
          <div className="footer_last_item">© 2023 Swiggy</div>
          <div
            style={{
              display: "flex",
              gap: "20px",
